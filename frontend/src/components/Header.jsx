    ...
    <header className="bg-slate-900/95 backdrop-blur-md text-white shadow-2xl sticky top-0 z-50 border-b border-slate-700/50 py-2">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items center">
        <Link to="/" className="flex items-center gap-2 group shrink-0">
          ...
          <span className="text-lg sm:text-xl font-extrabold tracking-tight uppercase transition-colors" style={{ background: 'linear-gradient(135deg, #ffffff 0%, #10b981 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>AI <span className="text-teal-500">INT</span><span className="hidden sm:inline">erviewer</span></span>
        </Link>
